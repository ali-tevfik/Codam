...
/*   Updated: 2021/07/29 17:31:09 by catalina      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_array	digit_3_speaciel(t_array array)
{
	...
	i = 0;
	while (1 && array.len_array_a > 1 && array.array_a)
	{
		if (array.array_a[0] > array.array_a[array.len_array_a - 1])
			array = rules_rotate_ra(array);
		else if (array.array_a[array.len_array_a - 1]
			< array.array_a[array.len_array_a - 2])
